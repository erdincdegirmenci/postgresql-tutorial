...
5. [İleri Düzey Fonksiyonlar ve İşlemler](#5-ileri-düzey-fonksiyonlar-ve-i̇slemler)
...
7. [Performans ve Kilitleme](#7-performans-ve-kilitleme)
   - [Kilitleme Seçenekleri](#kilitleme-seçenekleri)
   - [Transaction Isolation Level](#transaction-isolation-level)
8. [Veritabanı Yönetimi ve Bilgi](#8-veritabanı-yönetimi-ve-bilgi)
...
[Database ve Tablolar](crud_script.sql)
